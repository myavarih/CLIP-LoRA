...
template = ['a photo of a {}, a type of red kidney bean crop.']

CLASS_MAP = {
    'lape': 'split red bean',
    'salem': 'intact whole red bean',
    'sang': 'foreign stone impurity',
    'zayeat': 'defective waste red bean'
}

class LobiaGhermez(DatasetBase):
    dataset_dir = 'LobiaGhermez_gharebaghi_1'
