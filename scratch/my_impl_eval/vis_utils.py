...
def plot_confusion_matrix(*args, **kwargs):
    return
def _old_plot_confusion_matrix(y_true, y_pred, classes, save_path, split_name=""):
...
def plot_predictions(*args, **kwargs):
    return
def _old_plot_predictions(images, y_true, y_pred, classes, save_path, probabilities=None, num_images=None, split_name=""):
...
def plot_embeddings(*args, **kwargs):
    return
def _old_plot_embeddings(image_features, text_features, image_labels, classes, save_path, method='tsne', split_name=""):
    # Convert to numpy
...
def visualize_attention(*args, **kwargs):
    return
def _old_visualize_attention(image, attention_map, save_path, split_name="", class_name=""):
