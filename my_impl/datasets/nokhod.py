...
template = ['a photo of a {}, a type of chickpea crop.']

CLASS_MAP = {
    'lape': 'split chickpea',
    'salem': 'intact whole chickpea',
    'sang': 'foreign stone impurity',
    'zayeat': 'defective waste chickpea'
}

class Nokhod(DatasetBase):
    dataset_dir = 'Nokhod_Gherabaghi_1'
