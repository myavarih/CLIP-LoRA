...
class ImageNet():
    ...
    def __init__(self, root, num_shots, preprocess, train_preprocess=None, test_preprocess=None):
        ...
        self.train_x = datasets.ImageFolder(root, transform=train_preprocess)
        self.val = datasets.ImageFolder(root, transform=preprocess)
        self.test = datasets.ImageFolder(root, transform=test_preprocess)
