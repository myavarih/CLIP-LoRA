...
template = ['a photo of a {} pistachio, a type of pistachio nut.']

CLASS_MAP = {
    'maghz': 'shelled kernel',
    'nime shekan': 'semi-cracked in shell',
    'poost': 'empty outer shell'
}

class PistachioPoostMaghz(DatasetBase):
    dataset_dir = 'Pistachio_poost maghz_12'
